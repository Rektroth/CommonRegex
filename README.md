...
*Note: This is the official RFC specification, but it not generally recommended that it be the only method used to validate emails. Less broad regular expressions for emails may be added in the future.
